...
\hypertarget{class_senergy_1_1_socket_a824cf26338b12e1591b78d23abf6032a}{\index{Senergy\-::\-Socket@{Senergy\-::\-Socket}!I\-P\-V4\-Address\-From\-Binary@{I\-P\-V4\-Address\-From\-Binary}}
\index{I\-P\-V4\-Address\-From\-Binary@{I\-P\-V4\-Address\-From\-Binary}!Senergy::Socket@{Senergy\-::\-Socket}}
\subsubsection[{I\-P\-V4\-Address\-From\-Binary}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string Senergy\-::\-Socket\-::\-I\-P\-V4\-Address\-From\-Binary (
\begin{DoxyParamCaption}
\item[{unsigned int}]{binary}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_senergy_1_1_socket_a824cf26338b12e1591b78d23abf6032a}


Converts a 32-\/bit unsigned integer, which contains a I\-P\-V4 address to it's textual representation, where each 8 bit chunk is separated by a dot. 


\begin{DoxyParams}{Parameters}
{\em binary} & The binary value of the I\-P\-V4 address to convert to it's textual representation.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The textual representation of the specified binary I\-P\-V4 address. An empty string is returned when something went wrong. 
\end{DoxyReturn}


Definition at line 469 of file socket.\-cpp.

\hypertarget{class_senergy_1_1_socket_a74c62f0fb79be1192eed5f2fd092dd50}{\index{Senergy\-::\-Socket@{Senergy\-::\-Socket}!I\-P\-V4\-Address\-To\-Binary@{I\-P\-V4\-Address\-To\-Binary}}
\index{I\-P\-V4\-Address\-To\-Binary@{I\-P\-V4\-Address\-To\-Binary}!Senergy::Socket@{Senergy\-::\-Socket}}
\subsubsection[{I\-P\-V4\-Address\-To\-Binary}]{\setlength{\rightskip}{0pt plus 5cm}unsigned int Senergy\-::\-Socket\-::\-I\-P\-V4\-Address\-To\-Binary (
\begin{DoxyParamCaption}
\item[{std\-::string}]{ip}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_senergy_1_1_socket_a74c62f0fb79be1192eed5f2fd092dd50}


Converts the textual representation of a I\-P\-V4 address to it's binary form. 

In it's textual representation, each 8 bit chunk is separated by a dot. During conversion, these 8 bit chunks are parsed out and converted to to fit in a 32 bit integer (8 $\ast$ 4 = 32).


\begin{DoxyParams}{Parameters}
{\em ip} & The textual representation of an I\-P\-V4 address to convert to it's binary form.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The binary form of the specified I\-P\-V4 address. Zero is returned when something went wrong. 
\end{DoxyReturn}
