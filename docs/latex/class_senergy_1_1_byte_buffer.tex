...
\hypertarget{class_senergy_1_1_byte_buffer_a2db9cbd7f2eadd1ecb561c72feaca7ad}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Copy\-To@{Copy\-To}}
\index{Copy\-To@{Copy\-To}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Copy\-To}]{\setlength{\rightskip}{0pt plus 5cm}bool Senergy\-::\-Byte\-Buffer\-::\-Copy\-To (
\begin{DoxyParamCaption}
\item[{{\bf Byte\-Buffer} \&}]{buffer, }
\item[{int}]{amount}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_a2db9cbd7f2eadd1ecb561c72feaca7ad}
...
{\em buffer} & The buffer to copy the bytes to. \\
\hline
{\em amount} & The amount of bytes to copy to the specified buffer.\\
\hline
\end{DoxyParams}
...
\hypertarget{class_senergy_1_1_byte_buffer_a86a02f0e4d2aece53b7867e9a8011e70}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Decrease\-Position@{Decrease\-Position}}
\index{Decrease\-Position@{Decrease\-Position}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Decrease\-Position}]{\setlength{\rightskip}{0pt plus 5cm}bool Senergy\-::\-Byte\-Buffer\-::\-Decrease\-Position (
\begin{DoxyParamCaption}
\item[{int}]{amount = {\ttfamily 1}}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_a86a02f0e4d2aece53b7867e9a8011e70}
...
\begin{DoxyParams}{Parameters}
{\em amount} & The amount of bytes to decrease the position with, by default this is 1.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hypertarget{class_senergy_1_1_byte_buffer_a475f2133734cd74c4bce78bdf09950f3}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Dump\-Hexadecimal@{Dump\-Hexadecimal}}
\index{Dump\-Hexadecimal@{Dump\-Hexadecimal}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Dump\-Hexadecimal}]{\setlength{\rightskip}{0pt plus 5cm}void Senergy\-::\-Byte\-Buffer\-::\-Dump\-Hexadecimal (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_a475f2133734cd74c4bce78bdf09950f3}
...
\hypertarget{class_senergy_1_1_byte_buffer_a4276f5ed69bd1d2fe9c26e05193715f2}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Dump\-Hexadecimal@{Dump\-Hexadecimal}}
\index{Dump\-Hexadecimal@{Dump\-Hexadecimal}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Dump\-Hexadecimal}]{\setlength{\rightskip}{0pt plus 5cm}void Senergy\-::\-Byte\-Buffer\-::\-Dump\-Hexadecimal (
\begin{DoxyParamCaption}
\item[{int}]{start, }
\item[{int}]{amount}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_a4276f5ed69bd1d2fe9c26e05193715f2}
...
\begin{DoxyParams}{Parameters}
{\em start} & The offset/position at which we should start dumping \\
\hline
{\em amount} & The amount of bytes to display from the specified offset/position. \\
\hline
\end{DoxyParams}
...
\hypertarget{class_senergy_1_1_byte_buffer_a2747633838b3fae217b90700ff737840}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Has\-Reached\-End@{Has\-Reached\-End}}
\index{Has\-Reached\-End@{Has\-Reached\-End}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Has\-Reached\-End}]{\setlength{\rightskip}{0pt plus 5cm}bool Senergy\-::\-Byte\-Buffer\-::\-Has\-Reached\-End (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_a2747633838b3fae217b90700ff737840}
...
\hypertarget{class_senergy_1_1_byte_buffer_ad2ed70d80d2a794d2ce35931819a66da}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Increase\-Position@{Increase\-Position}}
\index{Increase\-Position@{Increase\-Position}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Increase\-Position}]{\setlength{\rightskip}{0pt plus 5cm}bool Senergy\-::\-Byte\-Buffer\-::\-Increase\-Position (
\begin{DoxyParamCaption}
\item[{int}]{amount = {\ttfamily 1}}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_ad2ed70d80d2a794d2ce35931819a66da}
...
\begin{DoxyParams}{Parameters}
{\em amount} & The amount of bytes to increase the position with, by default this is 1.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A boolean indicating whether setting the position to the requested offset succeseeded. True is returned when the operation succeseeded and false is returned when the operation failed. 
...
\begin{DoxyParams}{Parameters}
{\em buffer} & The buffer to write the acquired data to, make sure the buffer is at least the size of of the specified maximum size. \\
\hline
{\em max\-\_\-size} & The maximum amount of bytes to copy into the specified buffer, the size of the specified buffer.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hypertarget{class_senergy_1_1_byte_buffer_ab1f14bdb0b09b2144d1775fa2dff95a6}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Read\-String@{Read\-String}}
\index{Read\-String@{Read\-String}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Read\-String}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string Senergy\-::\-Byte\-Buffer\-::\-Read\-String (
\begin{DoxyParamCaption}
\item[{unsigned int}]{max\-\_\-length = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_ab1f14bdb0b09b2144d1775fa2dff95a6}
...
\begin{DoxyParams}{Parameters}
{\em max\-\_\-length} & Specifies the maximum length of the string being returned. Specifying zero disables this functionality.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Accounts for the string termination character (\textbackslash{}0).
\end{DoxyNote}
...
\hypertarget{class_senergy_1_1_byte_buffer_ad810aade775871238b82deb38629510e}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Write\-Nop@{Write\-Nop}}
\index{Write\-Nop@{Write\-Nop}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
\subsubsection[{Write\-Nop}]{\setlength{\rightskip}{0pt plus 5cm}void Senergy\-::\-Byte\-Buffer\-::\-Write\-Nop (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_senergy_1_1_byte_buffer_ad810aade775871238b82deb38629510e}
...
\hypertarget{class_senergy_1_1_byte_buffer_ab510887d735ee73ab1cb598c66260e87}{\index{Senergy\-::\-Byte\-Buffer@{Senergy\-::\-Byte\-Buffer}!Socket@{Socket}}
\index{Socket@{Socket}!Senergy::ByteBuffer@{Senergy\-::\-Byte\-Buffer}}
