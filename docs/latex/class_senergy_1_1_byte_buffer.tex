...
\begin{DoxyCompactList}\small\item\em Dump everything from the current position to the standard output, where each byte in the buffer is dumped in it's hexadecimal representation. Each byte will be separated by a space and after 35 bytes, a new line is created. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Friends}
\begin{DoxyCompactItemize}
\item 
